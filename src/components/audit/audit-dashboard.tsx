      ...
      <Card className="p-6 bg-white shadow-sm">
        <div className="flex gap-4 items-center">
          ...
          <div className="flex gap-2">
            <ConfirmDialog
              title="Resetar Dados"
              description="Tem certeza que deseja apagar todos os dados de auditoria? Esta ação não pode ser desfeita."
              trigger={
              ...
              onConfirm={async () => {
                try {
                  ...
                  toast({
                    ...
                    description: "Todos os dados de auditoria foram apagados",
                  });
                } catch (error) {
